...
io.on("connection", (socket) => {
    ...
    // console.log("setupp",userData.data._id);
 ...
 // this room is for typinf indicator opnent know that he is typing
...
socket.on("stop typing", (room) => socket.in(room).emit("stop typing"));
 ...
 socket.off("setup", () => {
    console.log("Dis COnnect socket");
